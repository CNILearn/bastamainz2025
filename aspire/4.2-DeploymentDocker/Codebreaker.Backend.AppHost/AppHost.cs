...
var hostEnvironment = builder.Configuration["HostEnvironment"] ?? "Azure";

if (hostEnvironment == "Docker")
{
    var environment = builder.AddDockerComposeEnvironment("codebreaker");
}
