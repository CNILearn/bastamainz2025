...
Type: TestNamespace.BusinessService
  Method: ProcessData(String)
  Method: Calculate(Int32)
  Method: LogMessage(String)

Type: TestNamespace.DataProcessor
  Method: ProcessItems(List)
...
";
    ...
    public static string[] GetTypeNames()
    {
        return new string[]
        {
            "TestNamespace.BusinessService",
            "TestNamespace.DataProcessor",
